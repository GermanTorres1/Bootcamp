 ...
 *     @fileOverview Module III Lab 1 
 *     @licence BSD 3-Clause License
 */


const iterateUsers =  [{"user_id":1,"first_name":"Peadar","last_name":"Popeley","age":24,"email":"ppopeley0@usnews.com","country":"China","favorite_color":"green","gender":"Male","shirt_size":"2XL"},
...
iterateUsers.forEach((value, index) => {
    console.log((value));
  });